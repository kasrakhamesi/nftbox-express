...
router.put('/admins/tables/categories/id/:id', adminsPassport, tables.categories.update)
router.get('/admins/tables/categories/id/:id', adminsPassport, tables.categories.findOne)
router.get('/admins/tables/categories', adminsPassport, tables.categories.findAll)
