...
router.put(
    ...
    adminsPassport,
    admins.authentications.changePassword
)
...
router.get(
    '/admins/managements/roles/id/:id',
    adminsPassport,
    admins.managements.adminsRoles.findOne
)
router.get(
    '/admins/managements/roles',
    adminsPassport,
    admins.managements.adminsRoles.findAll
)

router.get(
    '/admins/managements/permissions/id/:id',
    adminsPassport,
    admins.managements.adminsPermissions.findOne
)
router.get(
    '/admins/managements/permissions',
    adminsPassport,
    admins.managements.adminsPermissions.findAll
)

router.get(
    '/admins/managements/roles-permissions/id/:id',
    adminsPassport,
    admins.managements.adminsRolesPermissions.findOne
)
router.get(
    '/admins/managements/roles-permissions',
    adminsPassport,
    admins.managements.adminsRolesPermissions.findAll
)
